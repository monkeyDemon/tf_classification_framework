...
Contains definitions for the original form of Residual Networks(resnet_v1).

you can define some kinds of official resnet v1 models with differents layer numbers.
...
resnet_family = ['resnet-v1-20', 'resnet-v1-35', 'resnet-v1-50', 'resnet-v1-101', 'resnet-v1-152', 'resnet-v1-200']
