# -*- coding: utf-8 -*-
"""
Created on Mon Aug 26 16:16:08 2019

Contains definitions for the preactivation form of Residual Networks(resnet_v2).

you can define some kinds of official resnet v2 models with differents layer numbers.
...
you can also customize some resnet v2 model with shallower layers.
e.g. resnet35

this file is modified on tensorflow/tensorflow/contrib/slim/python/slim/nets/resnet_v2.py
...
from net.resnet_slim import resnet_utils

resnet_arg_scope = resnet_utils.resnet_arg_scope

# TODO: models currently supported for construction
resnet_family = ['resnet-v2-20', 'resnet-v2-35', 'resnet-v2-50', 'resnet-v2-101', 'resnet-v2-152', 'resnet-v2-200']
...
def resnet_v2_20(inputs,
                 ...
                 reuse=None,
                 scope='resnet_v2_20'):
  """Customized lightweight ResNet_v2_20 model. See resnet_v2() for arg and return description."""
  blocks = [
...
def resnet_v2_35(inputs,
                 ...
                 reuse=None,
                 scope='resnet_v2_35'):
  """Customized lightweight ResNet_v2_35 model. See resnet_v2() for arg and return description."""
  blocks = [
